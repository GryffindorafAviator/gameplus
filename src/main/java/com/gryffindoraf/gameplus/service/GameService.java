...
public class GameService {
    private static final String TOKEN = "Bearer s8jxfnomrbb1rzv08zwr5rgiy3f6iy";
    ...
    private static final String VIDEO_SEARCH_URL_TEMPLATE = "https://api.twitch.tv/helix/video?game_id=%s&first=%s";
