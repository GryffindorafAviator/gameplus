package com.gryffindoraf.gameplus.controller;

import com.gryffindoraf.gameplus.entity.db.Item;
import com.gryffindoraf.gameplus.entity.request.FavoriteRequestBody;
import com.gryffindoraf.gameplus.service.FavoriteService;
...
public class FavoriteController {
    ...
    public void unsetFavoriteItem(@RequestBody FavoriteRequestBody requestBody, HttpServletRequest request, HttpServletResponse response) {
        ...
        String useId = (String) session.getAttribute("user_id");
        favoriteService.unsetFavoriteItem(useId, requestBody.getFavoriteItem().getId());
    }
