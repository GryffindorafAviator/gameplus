...
public class ApplicationConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.gryffindoraf.gameplus.entity.db");
    ...
    public DataSource dataSource() {
        String RDS_ENDPOINT = "your rds instance address";
    ...
    private final Properties hibernateProties() {
